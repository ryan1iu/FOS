...
static inline void breakpoint(void) { asm volatile("int3"); }
...
static inline void lidt(void *p) { asm volatile("lidt (%0)" : : "r"(p)); }

static inline void lgdt(void *p) { asm volatile("lgdt (%0)" : : "r"(p)); }
